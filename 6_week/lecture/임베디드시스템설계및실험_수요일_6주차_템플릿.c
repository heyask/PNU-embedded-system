// flash load "C:\project1\wed06\flashclear.axf"
// flash load "C:\project1\wed06\Debug\wed06.axf"
...
void EXTI_Configure() {
    ...
    EXTI_InitStructure_LEFT.EXTI_Trigger = EXTI_Trigger_Rising;
    ...
    EXTI_InitStructure_RIGH.EXTI_Trigger = EXTI_Trigger_Rising;
    ...
    EXTI_InitStructure_SELE.EXTI_Trigger = EXTI_Trigger_Rising;
    ...
    EXTI_InitStructure_BUTT.EXTI_Trigger = EXTI_Trigger_Rising;
...
void NVIC_Configure() {
    ...
    NVIC_InitStructure_RIGH.NVIC_IRQChannelPreemptionPriority = 0x00;
    NVIC_InitStructure_RIGH.NVIC_IRQChannelSubPriority = 0x01;
    ...
    NVIC_InitStructure_SELE.NVIC_IRQChannelPreemptionPriority = 0x00;
    NVIC_InitStructure_SELE.NVIC_IRQChannelSubPriority = 0x02;
    ...
    NVIC_InitStructure_BUTT.NVIC_IRQChannelPreemptionPriority = 0x00;
    NVIC_InitStructure_BUTT.NVIC_IRQChannelSubPriority = 0x03;
